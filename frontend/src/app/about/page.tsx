      ...
      <nav className="border-b border-slate-800 bg-slate-900/80 backdrop-blur sticky top-0 z-30">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-4 text-sm">
            <Link href="/markets" className="text-slate-400 hover:text-slate-100">Markets</Link>
            <Link href="/login" className="text-slate-400 hover:text-slate-100">Sign in</Link>
            <Link href="/register" className="rounded-full bg-emerald-500 px-4 py-1.5 font-semibold text-slate-950 hover:bg-emerald-400">Get started</Link>
          </div>
        </div>
      </nav>
