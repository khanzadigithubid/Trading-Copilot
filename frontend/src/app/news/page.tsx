      ...
      <nav className="border-b border-slate-800 bg-slate-900/80 backdrop-blur sticky top-0 z-30">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          ...
          <div className="hidden sm:flex items-center gap-5 text-sm text-slate-400">
            ...
            <Link href="/news" className="text-emerald-400 font-medium">News</Link>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-sm text-slate-400 hover:text-slate-100">Sign in</Link>
            <Link href="/register" className="rounded-full bg-emerald-500 px-4 py-1.5 text-sm font-semibold text-slate-950 hover:bg-emerald-400">Get started</Link>
          </div>
        </div>
      </nav>

      <section className="border-b border-slate-800 bg-slate-900/30 px-6 py-12 text-center">
